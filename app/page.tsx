...
import { getDashboardData, getWorkspaceContext } from '@/lib/db/queries'
...
export default async function Page({
  ...
  try {
    const { currentUser, people: workspacePeople } = await getWorkspaceContext()
    if (!currentUser) {
      errorMessage = null
      currentUserId = null
      dashboardData = null
      ...
      dashboardData = await getDashboardData(currentUser)
