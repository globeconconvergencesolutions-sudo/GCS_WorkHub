...
type TaskStatus = 'In progress' | 'Waiting' | 'Not started' | 'Completed' | 'Blocked'
type Task = { id: number; title: string; category: string; owner: string; initials: string; status: TaskStatus; due: string; priority: 'High' | 'Medium' | 'Low' }

const initialTasks: Task[] = [
  { id: 1, title: 'Finalize Q3 operations review', category: 'Administrative', owner: 'Amara Okafor', initials: 'AO', status: 'In progress', due: 'Today', priority: 'High' },
  { id: 2, title: 'Update client onboarding checklist', category: 'Support', owner: 'David Mensah', initials: 'DM', status: 'Waiting', due: 'Tomorrow', priority: 'Medium' },
  { id: 3, title: 'Prepare campaign performance report', category: 'Marketing', owner: 'Lina Chen', initials: 'LC', status: 'Not started', due: 'Aug 22', priority: 'Medium' },
  { id: 4, title: 'Resolve payroll reconciliation', category: 'Finance', owner: 'James Wilson', initials: 'JW', status: 'Blocked', due: 'Aug 23', priority: 'High' },
  { id: 5, title: 'Deploy internal knowledge base', category: 'Technical', owner: 'Nia Johnson', initials: 'NJ', status: 'Completed', due: 'Aug 18', priority: 'Low' },
]
